...
import com.shoddytcg.server.backend.entity.Deck;
import com.shoddytcg.server.backend.entity.PlayerChar;
import com.shoddytcg.server.backend.entity.PlayerChar.RequestType;
import com.shoddytcg.server.network.message.ShoddyMessage;
import com.shoddytcg.server.network.message.RequestMessage;
...
public class TcpProtocolHandler extends IoHandlerAdapter {
	 ...
	 * @param m
	 */
	public static void writeMessage(IoSession session, ShoddyMessage m) {
